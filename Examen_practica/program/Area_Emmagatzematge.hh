...
public:
    ...
    */
    ...
    /** @brief Operació d'escriptura de l'area d'emmagatzematge2
        \pre <em>Cert<em>
        \post S'ha escrit pel canal de sortida l'area d'emmagatzematge tal com diu l'enunciat del examen
    */
    void AreaEmmagatzematge2();
